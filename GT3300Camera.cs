...
namespace gf
{
    public class GT3300Camera : AVT.VmbAPINET.Camera
    {
        #region Constructors.
        ...
        #region Category /ActionControl

        public long ActionDeviceKey
        {
            get { return ActionDeviceKeyFeature.IntValue; }
            set { ActionDeviceKeyFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature ActionDeviceKeyFeature
        {
            get
            {
                if (m_ActionDeviceKeyFeature == null)
                    m_ActionDeviceKeyFeature = Features ["ActionDeviceKey"];
                return m_ActionDeviceKeyFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_ActionDeviceKeyFeature = null;

        public long ActionGroupKey
        {
            get { return ActionGroupKeyFeature.IntValue; }
            set { ActionGroupKeyFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature ActionGroupKeyFeature
        {
            get
            {
                if (m_ActionGroupKeyFeature == null)
                    m_ActionGroupKeyFeature = Features ["ActionGroupKey"];
                return m_ActionGroupKeyFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_ActionGroupKeyFeature = null;

        public long ActionGroupMask
        {
            get { return ActionGroupMaskFeature.IntValue; }
            set { ActionGroupMaskFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature ActionGroupMaskFeature
        {
            get
            {
                if (m_ActionGroupMaskFeature == null)
                    m_ActionGroupMaskFeature = Features ["ActionGroupMask"];
                return m_ActionGroupMaskFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_ActionGroupMaskFeature = null;

        public long ActionSelector
        {
            get { return ActionSelectorFeature.IntValue; }
            set { ActionSelectorFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature ActionSelectorFeature
        {
            get
            {
                if (m_ActionSelectorFeature == null)
                    m_ActionSelectorFeature = Features ["ActionSelector"];
                return m_ActionSelectorFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_ActionSelectorFeature = null;
        ...
        public bool DefectMaskEnable
        {
            get { return DefectMaskEnableFeature.BoolValue; }
            set { DefectMaskEnableFeature.BoolValue = value; }
        }
        public AVT.VmbAPINET.Feature DefectMaskEnableFeature
        {
            get
            {
                if (m_DefectMaskEnableFeature == null)
                    m_DefectMaskEnableFeature = Features ["DefectMaskEnable"];
                return m_DefectMaskEnableFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_DefectMaskEnableFeature = null;
        ...
        #region Category /Controls/Iris

        public long IrisAutoTarget
        {
            get { return IrisAutoTargetFeature.IntValue; }
            set { IrisAutoTargetFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature IrisAutoTargetFeature
        {
            get
            {
                if (m_IrisAutoTargetFeature == null)
                    m_IrisAutoTargetFeature = Features ["IrisAutoTarget"];
                return m_IrisAutoTargetFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_IrisAutoTargetFeature = null;

        public IrisModeEnum IrisMode
        {
            get { return (IrisModeEnum) IrisModeFeature.EnumIntValue; }
            set { IrisModeFeature.EnumIntValue = (int) value; }
        }
        public AVT.VmbAPINET.Feature IrisModeFeature
        {
            get
            {
                if (m_IrisModeFeature == null)
                    m_IrisModeFeature = Features ["IrisMode"];
                return m_IrisModeFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_IrisModeFeature = null;

        public long IrisVideoLevel
        {
            get { return IrisVideoLevelFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature IrisVideoLevelFeature
        {
            get
            {
                if (m_IrisVideoLevelFeature == null)
                    m_IrisVideoLevelFeature = Features ["IrisVideoLevel"];
                return m_IrisVideoLevelFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_IrisVideoLevelFeature = null;

        #endregion

        #region Category /Controls/Iris/LensDCIris

        public long LensDCDriveStrength
        {
            get { return LensDCDriveStrengthFeature.IntValue; }
            set { LensDCDriveStrengthFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature LensDCDriveStrengthFeature
        {
            get
            {
                if (m_LensDCDriveStrengthFeature == null)
                    m_LensDCDriveStrengthFeature = Features ["LensDCDriveStrength"];
                return m_LensDCDriveStrengthFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_LensDCDriveStrengthFeature = null;

        #endregion

        #region Category /Controls/Iris/LensPIris

        public long LensPIrisFrequency
        {
            get { return LensPIrisFrequencyFeature.IntValue; }
            set { LensPIrisFrequencyFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature LensPIrisFrequencyFeature
        {
            get
            {
                if (m_LensPIrisFrequencyFeature == null)
                    m_LensPIrisFrequencyFeature = Features ["LensPIrisFrequency"];
                return m_LensPIrisFrequencyFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_LensPIrisFrequencyFeature = null;

        public long LensPIrisNumSteps
        {
            get { return LensPIrisNumStepsFeature.IntValue; }
            set { LensPIrisNumStepsFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature LensPIrisNumStepsFeature
        {
            get
            {
                if (m_LensPIrisNumStepsFeature == null)
                    m_LensPIrisNumStepsFeature = Features ["LensPIrisNumSteps"];
                return m_LensPIrisNumStepsFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_LensPIrisNumStepsFeature = null;

        public long LensPIrisPosition
        {
            get { return LensPIrisPositionFeature.IntValue; }
            set { LensPIrisPositionFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature LensPIrisPositionFeature
        {
            get
            {
                if (m_LensPIrisPositionFeature == null)
                    m_LensPIrisPositionFeature = Features ["LensPIrisPosition"];
                return m_LensPIrisPositionFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_LensPIrisPositionFeature = null;
        ...
        #region Category /Controls/SubstrateVoltage

        public long VsubValue
        {
            get { return VsubValueFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature VsubValueFeature
        {
            get
            {
                if (m_VsubValueFeature == null)
                    m_VsubValueFeature = Features ["VsubValue"];
                return m_VsubValueFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_VsubValueFeature = null;
        ...
        public long EventAction0FrameID
        {
            get { return EventAction0FrameIDFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventAction0FrameIDFeature
        {
            get
            {
                if (m_EventAction0FrameIDFeature == null)
                    m_EventAction0FrameIDFeature = Features ["EventAction0FrameID"];
                return m_EventAction0FrameIDFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventAction0FrameIDFeature = null;

        public long EventAction0Timestamp
        {
            get { return EventAction0TimestampFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventAction0TimestampFeature
        {
            get
            {
                if (m_EventAction0TimestampFeature == null)
                    m_EventAction0TimestampFeature = Features ["EventAction0Timestamp"];
                return m_EventAction0TimestampFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventAction0TimestampFeature = null;

        public long EventAction1FrameID
        {
            get { return EventAction1FrameIDFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventAction1FrameIDFeature
        {
            get
            {
                if (m_EventAction1FrameIDFeature == null)
                    m_EventAction1FrameIDFeature = Features ["EventAction1FrameID"];
                return m_EventAction1FrameIDFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventAction1FrameIDFeature = null;

        public long EventAction1Timestamp
        {
            get { return EventAction1TimestampFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventAction1TimestampFeature
        {
            get
            {
                if (m_EventAction1TimestampFeature == null)
                    m_EventAction1TimestampFeature = Features ["EventAction1Timestamp"];
                return m_EventAction1TimestampFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventAction1TimestampFeature = null;
        ...
        public long EventLine2FallingEdgeFrameID
        {
            get { return EventLine2FallingEdgeFrameIDFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventLine2FallingEdgeFrameIDFeature
        {
            get
            {
                if (m_EventLine2FallingEdgeFrameIDFeature == null)
                    m_EventLine2FallingEdgeFrameIDFeature = Features ["EventLine2FallingEdgeFrameID"];
                return m_EventLine2FallingEdgeFrameIDFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventLine2FallingEdgeFrameIDFeature = null;

        public long EventLine2FallingEdgeTimestamp
        {
            get { return EventLine2FallingEdgeTimestampFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventLine2FallingEdgeTimestampFeature
        {
            get
            {
                if (m_EventLine2FallingEdgeTimestampFeature == null)
                    m_EventLine2FallingEdgeTimestampFeature = Features ["EventLine2FallingEdgeTimestamp"];
                return m_EventLine2FallingEdgeTimestampFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventLine2FallingEdgeTimestampFeature = null;

        public long EventLine2RisingEdgeFrameID
        {
            get { return EventLine2RisingEdgeFrameIDFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventLine2RisingEdgeFrameIDFeature
        {
            get
            {
                if (m_EventLine2RisingEdgeFrameIDFeature == null)
                    m_EventLine2RisingEdgeFrameIDFeature = Features ["EventLine2RisingEdgeFrameID"];
                return m_EventLine2RisingEdgeFrameIDFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventLine2RisingEdgeFrameIDFeature = null;

        public long EventLine2RisingEdgeTimestamp
        {
            get { return EventLine2RisingEdgeTimestampFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventLine2RisingEdgeTimestampFeature
        {
            get
            {
                if (m_EventLine2RisingEdgeTimestampFeature == null)
                    m_EventLine2RisingEdgeTimestampFeature = Features ["EventLine2RisingEdgeTimestamp"];
                return m_EventLine2RisingEdgeTimestampFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventLine2RisingEdgeTimestampFeature = null;
        ...
        public long EventPtpSyncLockedFrameID
        {
            get { return EventPtpSyncLockedFrameIDFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventPtpSyncLockedFrameIDFeature
        {
            get
            {
                if (m_EventPtpSyncLockedFrameIDFeature == null)
                    m_EventPtpSyncLockedFrameIDFeature = Features ["EventPtpSyncLockedFrameID"];
                return m_EventPtpSyncLockedFrameIDFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventPtpSyncLockedFrameIDFeature = null;

        public long EventPtpSyncLockedTimestamp
        {
            get { return EventPtpSyncLockedTimestampFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventPtpSyncLockedTimestampFeature
        {
            get
            {
                if (m_EventPtpSyncLockedTimestampFeature == null)
                    m_EventPtpSyncLockedTimestampFeature = Features ["EventPtpSyncLockedTimestamp"];
                return m_EventPtpSyncLockedTimestampFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventPtpSyncLockedTimestampFeature = null;

        public long EventPtpSyncLostFrameID
        {
            get { return EventPtpSyncLostFrameIDFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventPtpSyncLostFrameIDFeature
        {
            get
            {
                if (m_EventPtpSyncLostFrameIDFeature == null)
                    m_EventPtpSyncLostFrameIDFeature = Features ["EventPtpSyncLostFrameID"];
                return m_EventPtpSyncLostFrameIDFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventPtpSyncLostFrameIDFeature = null;

        public long EventPtpSyncLostTimestamp
        {
            get { return EventPtpSyncLostTimestampFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventPtpSyncLostTimestampFeature
        {
            get
            {
                if (m_EventPtpSyncLostTimestampFeature == null)
                    m_EventPtpSyncLostTimestampFeature = Features ["EventPtpSyncLostTimestamp"];
                return m_EventPtpSyncLostTimestampFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventPtpSyncLostTimestampFeature = null;
        ...
        public long EventAction0
        {
            get { return EventAction0Feature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventAction0Feature
        {
            get
            {
                if (m_EventAction0Feature == null)
                    m_EventAction0Feature = Features ["EventAction0"];
                return m_EventAction0Feature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventAction0Feature = null;

        public long EventAction1
        {
            get { return EventAction1Feature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventAction1Feature
        {
            get
            {
                if (m_EventAction1Feature == null)
                    m_EventAction1Feature = Features ["EventAction1"];
                return m_EventAction1Feature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventAction1Feature = null;
        ...
        public long EventPtpSyncLocked
        {
            get { return EventPtpSyncLockedFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventPtpSyncLockedFeature
        {
            get
            {
                if (m_EventPtpSyncLockedFeature == null)
                    m_EventPtpSyncLockedFeature = Features ["EventPtpSyncLocked"];
                return m_EventPtpSyncLockedFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventPtpSyncLockedFeature = null;

        public long EventPtpSyncLost
        {
            get { return EventPtpSyncLostFeature.IntValue; }
        }
        public AVT.VmbAPINET.Feature EventPtpSyncLostFeature
        {
            get
            {
                if (m_EventPtpSyncLostFeature == null)
                    m_EventPtpSyncLostFeature = Features ["EventPtpSyncLost"];
                return m_EventPtpSyncLostFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_EventPtpSyncLostFeature = null;
        ...
        #region Category /GigE/PTP

        public long PtpAcquisitionGateTime
        {
            get { return PtpAcquisitionGateTimeFeature.IntValue; }
            set { PtpAcquisitionGateTimeFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature PtpAcquisitionGateTimeFeature
        {
            get
            {
                if (m_PtpAcquisitionGateTimeFeature == null)
                    m_PtpAcquisitionGateTimeFeature = Features ["PtpAcquisitionGateTime"];
                return m_PtpAcquisitionGateTimeFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_PtpAcquisitionGateTimeFeature = null;

        public PtpModeEnum PtpMode
        {
            get { return (PtpModeEnum) PtpModeFeature.EnumIntValue; }
            set { PtpModeFeature.EnumIntValue = (int) value; }
        }
        public AVT.VmbAPINET.Feature PtpModeFeature
        {
            get
            {
                if (m_PtpModeFeature == null)
                    m_PtpModeFeature = Features ["PtpMode"];
                return m_PtpModeFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_PtpModeFeature = null;

        public PtpStatusEnum PtpStatus
        {
            get { return (PtpStatusEnum) PtpStatusFeature.EnumIntValue; }
        }
        public AVT.VmbAPINET.Feature PtpStatusFeature
        {
            get
            {
                if (m_PtpStatusFeature == null)
                    m_PtpStatusFeature = Features ["PtpStatus"];
                return m_PtpStatusFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_PtpStatusFeature = null;
        ...
        public long DecimationHorizontal
        {
            get { return DecimationHorizontalFeature.IntValue; }
            set { DecimationHorizontalFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature DecimationHorizontalFeature
        {
            get
            {
                if (m_DecimationHorizontalFeature == null)
                    m_DecimationHorizontalFeature = Features ["DecimationHorizontal"];
                return m_DecimationHorizontalFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_DecimationHorizontalFeature = null;

        public long DecimationVertical
        {
            get { return DecimationVerticalFeature.IntValue; }
            set { DecimationVerticalFeature.IntValue = value; }
        }
        public AVT.VmbAPINET.Feature DecimationVerticalFeature
        {
            get
            {
                if (m_DecimationVerticalFeature == null)
                    m_DecimationVerticalFeature = Features ["DecimationVertical"];
                return m_DecimationVerticalFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_DecimationVerticalFeature = null;
        ...
        {
            get { return ReverseYFeature.BoolValue; }
            set { ReverseYFeature.BoolValue = value; }
        }
        public AVT.VmbAPINET.Feature ReverseYFeature
        {
            get
            {
                if (m_ReverseYFeature == null)
                    m_ReverseYFeature = Features ["ReverseY"];
                return m_ReverseYFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_ReverseYFeature = null;
        ...
        public AVT.VmbAPINET.Feature SensorDigitizationTapsFeature
        {
            get
            {
                if (m_SensorDigitizationTapsFeature == null)
                    m_SensorDigitizationTapsFeature = Features ["SensorDigitizationTaps"];
        ...
        public SensorTapsEnum SensorTaps
        {
            get { return (SensorTapsEnum) SensorTapsFeature.EnumIntValue; }
        }
        public AVT.VmbAPINET.Feature SensorTapsFeature
        {
            get
            {
                if (m_SensorTapsFeature == null)
                    m_SensorTapsFeature = Features ["SensorTaps"];
                return m_SensorTapsFeature;
            }
        }
        private AVT.VmbAPINET.Feature m_SensorTapsFeature = null;
